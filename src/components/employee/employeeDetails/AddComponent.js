...
function AddComponent({ employee, setEmployee }) {
  ...
  const handleOk = async () => {
    ...
    if (!isEdiTEmpComponent) {
      ...
      console.log("newObnewObnewOb", newOb);
      setEmployee(newOb);
    } else {
      console.log("isEdiTEmpComponent");
      const newList = [...employee.employeeComponents];
      let objIndex = employee.employeeComponents.findIndex(
        (obj) => obj.id == employeeComponent.id
      );
  ...
  const getPayment = (row) => {
    const res = paymentDaysTypes.filter(
      (item) => item.id == row.paymentDaysTypeId
    )[0];
    return res?.name;
  };
          ...
          <Row gutter={[16, 30]}>
            <Col className="gutter-row" span={8}>
              ...
              <Select
                ...
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(value, "projectId")
                }
            ...
            <Col className="gutter-row" span={8}>
              ...
              <Select
                ...
                style={{ width: 200, marginTop: 5 }}
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(value, "componentId")
                }
            ...
            <Col className="gutter-row" span={8}>
              ...
              <Select
                ...
                style={{ width: 200, marginTop: 5 }}
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(value, "costCenterId")
                }
            ...
            <Col className="gutter-row" span={8}>
              ...
              <Select
                ...
                style={{ width: 200, marginTop: 5 }}
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(
                    value,
                    "paymentDaysTypeId"
                  )
                }
            ...
            <Col className="gutter-row" span={8}>
              ...
              <Input
                type="number"
                style={{ marginTop: 5 }}
                value={employeeComponent.amount}
                name="amount"
                onChange={(e) => handleChangeEmployeeComponent(e)}
                placeholder="თანხა"
              />
            </Col>
            <Col className="gutter-row" span={8}>
            ...
            <Col className="gutter-row" span={8}>
              ...
              <DatePicker
                value={
                  employeeComponent.startDate
                    ? moment.utc(employeeComponent.startDate, "YYYY/MM/DD")
                    : null
                }
                style={{ marginTop: 5 }}
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(value, "startDate")
                }
              />
            </Col>
            <Col className="gutter-row" span={8}>
              ...
              <DatePicker
                value={
                  employeeComponent.endDate
                    ? moment.utc(employeeComponent.endDate, "YYYY/MM/DD")
                    : null
                }
                style={{ marginTop: 5 }}
                onChange={(value) =>
                  handleChangeEmployeeComponentSelect(value, "endDate")
                }
              />
            </Col>
          </Row>
